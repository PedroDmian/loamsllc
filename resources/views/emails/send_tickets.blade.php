...
<html>
    <head>
        ...
        <title>¡Tu pago ha sido procesado! Aquí están tus boletos de lotería</title>
        <style>
            /* -------------------------------------
          GLOBAL RESETS
      ------------------------------------- */
      ...
      ------------------------------------- */
            @media all {
                ...
                .btn-primary table td:hover {
                    background-color: #bc1920 !important;
                }
                .btn-primary a:hover {
                    background-color: #821920 !important;
                    border-color: #821920 !important;
                }
            }
                                    ...
                                    >
                                        <tr>
                                            <td style="text-align: center">
                                                <h2 style="font-weight: 700px; color: #000000">
                                                    LOAMS LLC
                                                </h2>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td>
                                                <h1 class="font-bold">
                                                  Your payment has been processed! Here are your tickets
                                                </h1>
                                                <p>
                                                  Dear
                                                    <strong>{{ $name }}</strong
                                                ...
                                                <p>
                                                  We are pleased to inform you that your payment for the lottery ticket purchase has been successfully processed, thank you for participating!
                                                </p>
                                                ...
                                                <p style="margin-top: 30px; text-align: center;">
                                                  Your lottery tickets have been sent to this email. Be sure to check the attached tickets
                                                </p>
                                                ...
                                                <p>
                                                  Good luck and thank you for choosing us! We hope you have an exciting lottery experience.
                                                </p>
                            ...
                            >
                                <tr>
                                    <td class="content-block powered-by">
                                        Please do not reply to this email; it is not monitored.<br />The content
                                        is generated automatically,
                                        Thank you.<br />
                                        Powered by
                                        <a href="https://loamsllc.com">Loamsllc.com</a>.
                                    </td>
                                </tr>
                            </table>
                        </div>
